...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-white/20 bg-transparent backdrop-blur-md backdrop-saturate-150 text-white shadow-xl",
      "bg-gradient-to-b from-white/[0.15] to-transparent",
      "transition-all duration-300",
      "hover:border-white/30 hover:from-white/[0.18] hover:shadow-2xl",
      className
    )}
    {...props}
  />
